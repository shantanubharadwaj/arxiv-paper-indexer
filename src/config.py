...
class Settings(DefaultSettings):
    ...
    ollama_models: Union[str, List[str]] = Field(default=["phi4-mini:3.8b", "llama3.2:3b"])
    ollama_default_model: str = "phi4-mini:3.8b"
    ollama_timeout: int = 300 # 5 minutes for larger operations
